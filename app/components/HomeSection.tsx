          ...
          <div className=" content section items-center flex-row justify-center  leading-snug">
            ...
            >
              ...
              <div className="mt-4 text-white font-medium">
                ...
                <div className="border-[1.5px] text-[14px] border-white px-4 py-1.5 w-fit rounded-lg mt-4">
                  8jzRznet3cR3Y1KhciwUxKEqPku3BLcfiJLpVjMU3NF7
                </div>
              </div>

              <button className="text-[16px] mt-8 font-medium px-4 py-1 sm:py-2 sm:px-8  rounded-lg bg-green-600 text-white">
                Explore now
              </button>
            </motion.div>
          </div>
