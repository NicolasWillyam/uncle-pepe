...
export default function Home() {
  return (
    <div className="w-full">
      ...
      <div className="">
        <div className="w-full h-auto sm:h-screen bg-cover bg-no-repeat bg-center bg-[url('https://pepecoinsol.xyz/assets/images//logo/o.jpg')]">
          <div className="w-full h-auto sm:h-screen bg-black/50 px-4 sm:px-0">
            <Header />
            <HomeSection />
          </div>
        </div>

        <div className="max-w-[1080px] mx-auto sm:px-0 px-4">
